...
<script>
	function getSelectedValue() {
		const selectedVariation = document.getElementById('variation_id');
		const quantity = document.getElementById('quantity');
		const variationStockQuantity = selectedVariation.options[selectedVariation.selectedIndex].id;
		quantity.value = variationStockQuantity;
	}
