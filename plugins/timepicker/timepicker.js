...
(function () {
            ...
            for (var i = disableTimeRanges.length - 1; i > 0; i--) {
              if (disableTimeRanges[i][0] <= disableTimeRanges[i - 1][1]) {
                disableTimeRanges[i - 1] = [
                  ...
                  Math.max(disableTimeRanges[i][1], disableTimeRanges[i - 1][1]),
                ];
          ...
          value: function _setSelected() {
            ...
            if (selected) {
              ...
              if (topDelta + selectedRect.height > listRect.height || topDelta < 0) {
                var newScroll =
                  list.scrollTop() + (selectedRect.top - listRect.top) - selectedRect.height;
  ...
  function _getDropdownTimes(tp) {
    ...
    var settings = tp.settings;
    var start =
      (_settings$minTime = settings.minTime()) !== null && _settings$minTime !== void 0
        ? _settings$minTime
        : 0;
    var end =
    ...
    var methods = {
      ...
      show: function show(e) {
        ...
        if (settings.orientation.match(/r/)) {
          ...
          listOffset.left =
            self.offset().left + parseInt(list.css('marginLeft').replace('px', ''), 10);
