...
<style>
    ...
    .name {
        ...
        max-width: 100%; /* Limit the maximum width to prevent container resizing */
        font-size: 20px;
...
<script>
    ...
    var isMinPriceValid = validatePriceInput(minPriceInput, minPriceError);
    var isMaxPriceValid = validatePriceInput(maxPriceInput, maxPriceError);
